...
public class Chunk {
	...
	public UIManager uIManager; //count each voxel and deisplay UI

	public int CountDirts = 0;
	public int CountAir = 0;
	public int d = 1;
	public int a = 1;
			...
			for(int y = 0; y < World.chunkSize; y++)
				for(int x = 0; x < World.chunkSize; x++)
				{
...

					{
						...
						//CountDirts = System.Enum.GetValues(typeof(Block.BlockType)).Length;
						//Debug.Log("DIRT:" + System.Enum.GetValues(typeof(Block.BlockType)).Length);
						//chunk.gameObject.tag = "DirtBlocks";
						...
						//Debug.Log("AIR:" + System.Enum.GetValues(typeof(Block.BlockType.AIR)).Length);
						//chunk.gameObject.tag = "AirBlocks";
						CounterAir();
				}
	}

	public void CounterDirt()

    {
			CountDirts = ++d;
			Debug.Log("DirtsNum:" + CountDirts);

	}

	public void CounterAir()

	{
		CountAir = ++a;
		Debug.Log("AirNum:" + CountAir);
    ...
    public Chunk (Vector3 position, Material c) {
		...
		//chunk.gameObject.tag = "TotalBlocks";
